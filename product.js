let item = document.getElementById('chair-cart')
...
item.onclick = () =>{
    ...
    switch(number){
        ...
        break;
        case '2':
        localStorage.setItem("item4Price", '2');
        break;
        case '3':
        localStorage.setItem("item4Price", '3');
        break;
        case '4':
        localStorage.setItem("item4Price", '4');
        break;
        case '5':
        localStorage.setItem("item4Price", '5');
        break;
        default:
        break;
    }
